package com.hrsst.housekeeper.mvp.recordProject;
...
public class RecordProjectActivity extends Activity implements View.OnClickListener,
    ...
    public void updateRecord(int state) {
        if (state == Constants.P2P_SET.REMOTE_RECORD_SET.RECORD_SWITCH_ON) {
            ...
            record_img.setBackgroundResource(R.mipmap.ic_checkbox_on);
        } else {
            last_record = Constants.P2P_SET.REMOTE_RECORD_SET.RECORD_SWITCH_OFF;
            record_img.setBackgroundResource(R.mipmap.ic_checkbox_off);
        }
    }
