...
import com.hrsst.housekeeper.adapter.DateNumericAdapter;
import com.hrsst.housekeeper.adapter.RecordAdapter;
import com.hrsst.housekeeper.common.data.Contact;
import com.hrsst.housekeeper.common.global.Constants;
import com.hrsst.housekeeper.common.widget.OnWheelScrollListener;
import com.hrsst.housekeeper.common.widget.WheelView;
    ...
    public void onClick(View arg0) {
        ...
        switch (arg0.getId()) {
            ...
            case R.id.search_detail:
                ...
                search_bar.setBackgroundResource(R.mipmap.dh_4);
                break;
            case R.id.search_one_day:
                ...
                search_bar.setBackgroundResource(R.mipmap.dh_1);
                this.replaceFrag(loadFrag, fragments[1]);
                selected_condition = 0;
                searchByTime(1);
                updateCondition();
            ...
            case R.id.search_three_day:
                ...
                search_bar.setBackgroundResource(R.mipmap.dh_2);
                this.replaceFrag(loadFrag, fragments[1]);
            ...
            case R.id.search_one_month:
                ...
                search_bar.setBackgroundResource(R.mipmap.dh_3);
                this.replaceFrag(loadFrag, fragments[1]);
