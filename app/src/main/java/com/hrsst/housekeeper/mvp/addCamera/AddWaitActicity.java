...
import com.hrsst.housekeeper.common.yoosee.UDPHelper;
...
public class AddWaitActicity extends Activity {
    ...
    @Bind(R.id.connect_doorsensor_image)
    ImageView connectDoorsensorImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_wait_camera);
        ButterKnife.bind(this);
        mContext = this;
        connectDoorsensorImage.setBackgroundResource(R.drawable.connect_camera_anim);
        mAnimationDrawable = (AnimationDrawable) connectDoorsensorImage.getBackground();
