...
import com.hrsst.housekeeper.common.utils.PhoneWatcher;
...
public class PlayBackActivity extends BasePlayBackActivity implements OnSeekBarChangeListener {
    @Bind(R.id.nowTime)
    TextView nowTime;
    @Bind(R.id.seek_bar)
    SeekBar seekbar;
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(Constants.P2P.P2P_REJECT)) {
                ...
                switch (state) {
                    case 0:
                        isPause = true;
                        pause.setImageResource(R.mipmap.playing_start);
                        break;
                    case 1:
                        isPause = true;
                        pause.setImageResource(R.mipmap.playing_start);
                    ...
                    case 2:
                        isPause = false;
                        pause.setImageResource(R.mipmap.playing_pause);
                        break;
                }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (event.getAction() == KeyEvent.ACTION_DOWN
            ...
            if (mCurrentVolume != 0) {
                mIsCloseVoice = false;
                stopVoice.setImageResource(R.mipmap.btn_playback_voice);
            }
            return false;
            ...
            if (mCurrentVolume == 0) {
                mIsCloseVoice = true;
                stopVoice.setImageResource(R.mipmap.btn_playback_voice_s);
            }
