...
public class CircleTextProgressbar extends TextView {
     ...
     * 外部轮廓的颜色。
     */
    private int outLineColor = getResources().getColor(R.color.alpha);
     ...
     * 进度条的颜色。
     */
    private int progressLineColor = getResources().getColor(R.color.colorPrimary);
     ...
     */
    public boolean stop() {
       return removeCallbacks(progressChangeTask);
    }
