...
public class FisheyeSetHandler {
    ...
    private static byte MESG_TYPE_QRCODE_LEARN_CODE= (byte) 216;
    ...
    private static int MESG_ID_TYPE_QRCODE_LEARN_CODE=Constants.MsgSection.MESG_ID_TYPE_QRCODE_LEARN_CODE;
    ...
    public void sGetCurrentWorkMode(String contactId, String password){
        ...
        Log.e("leleWorkMode", "contactId="+contactId);
        byte[] fishdata=new byte[4];
        fishdata[0]=MESG_TYPE_WORKMODE_SETTING;
    ...
    public void sMesgQrcodeLearnDevice(String contactId, String password,byte qrType,byte deviceType,byte[] codeData){
        if ((MESG_ID_TYPE_QRCODE_LEARN_CODE) >= (Constants.MsgSection.MESG_ID_TYPE_QRCODE_LEARN_CODE)) {
            MESG_ID_TYPE_QRCODE_LEARN_CODE = Constants.MsgSection.MESG_ID_TYPE_QRCODE_LEARN_CODE - 1000;
        }
        byte[] fishdata=new byte[22];
        fishdata[0]=MESG_TYPE_QRCODE_LEARN_CODE;
        fishdata[2]=qrType;
