...
public class P2PValue {
	public static class AlarmType{
		...
		public static final int ALARM_TYPE_SMOKE_ALARM=40;//40smoke    烟感报警 
		public static final int ALARM_TYPE_GAS_ALARM=41;//41gas        气感报警      
		public static final int ALARM_TYPE_DOOR_MAGNET=42;//42door magnet
		public static final int ALARM_TYPE_TEMPTATURE=43;//43temprature 温度报警
		public static final int ALARM_TYPE_HUMIDITY=44;//44humidity     湿度报警
